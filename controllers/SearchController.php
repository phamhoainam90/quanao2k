<?php 
	...
	class SearchController extends Controller{
		...
		public function searchProduct(){
			...
			$numPage = ceil($this->modelTotalSearchProduct()/$recordPerPage);
			//lay danh sach cac ban ghi co phan trang
			$data = $this->modelSearchProduct($recordPerPage);
			//goi view, truyen du lieu ra view
			$this->loadView("SearchProductView.php",["data"=>$data,"numPage"=>$numPage]);
		}
	}
 ?>