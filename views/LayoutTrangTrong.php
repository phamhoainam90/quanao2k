...
<head>
    ...
    <meta name="description" content="Nam">
    ...
    <link rel="stylesheet" type="text/css" href="assets/frontend/css/danhgia.css">
    ...
    <div class="box-icon row">
        <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="banner-footer-item">
                <p>
                    <img src="assets/frontend/images/icon-vanchuyen.png">
                </p>
        ...
        <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="banner-footer-item">
                <p>
                    <img src="assets/frontend/images/icon-hotro.png">
                </p>
                <div class="banner-footer-item-info">
        ...
        <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="banner-footer-item">
                <p>
                    <img src="assets/frontend/images/icon-doitra.png">
                </p>
                <div class="banner-footer-item-info">
...
<footer>
    ...
    <div class="copyright">
        <p style="display: block; margin: 0; color: #fff;">
            Thiết kế website bởi <img src="assets/frontend/images/favicon.ico" alt="Thiết kế web bởi NHANH.VN" title="Thiết kế web bởi NHANH.VN"/>
...
<script type="text/javascript" src="assets/frontend/js/t0260.store.nhanh.vn"></script>
<script type="text/javascript" src="assets/frontend/js/T1260.store.nhanh.vn"></script>
<script src="assets/frontend/js/location.vn.js" defer></script>
