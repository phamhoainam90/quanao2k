        ...
        <div class="row">
            ...
            <div class="paginate text-center">
                ...
                <div id="pagination">
                    <?php if($numPage>1): ?>
                    <div class="paginator">
                    <a rel="nofollow" class="paging-first"
                        href="index.php?controller=search&fromPrice=<?php echo $fromPrice; ?>&toPrice=<?php echo $toPrice; ?>&category_id=<?php echo $category_id;?>&page=1"></a>
                        <?php for($i = 1; $i <= $numPage; $i++): ?>
                        <a class="currentPage"
                            href="index.php?controller=search&fromPrice=<?php echo $fromPrice; ?>&toPrice=<?php echo $toPrice; ?>&category_id=<?php echo $category_id;?>&page=<?php echo $i; ?>"><?php echo $i; ?></a>
                        <?php endfor; ?>
                        <a rel="nofollow" class="paging-last" href="index.php?controller=search&fromPrice=<?php echo $fromPrice; ?>&toPrice=<?php echo $toPrice; ?>&category_id=<?php echo $category_id;?>&page=<?php echo $numPage ?>"></a>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
